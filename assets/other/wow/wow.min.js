      ...
      return (
        n(a, [
          ...
          },
          {
            ...
            value: function (a, b, c, d, e) {
              return (
                ...
                c && this.otherSet(a.style, { animationDuration: c }),
                d && this.otherSet(a.style, { animationDelay: d }),
                e && this.otherSet(a.style, { animationIterationCount: e }),
                this.otherSet(a.style, { animationName: b ? "none" : this.cachedAnimationName(a) }),
                a
              );
            },
          },
          ...
          },
          {
            key: "otherCSS",
            value: function (a, b) {
              for (var c = q(a), d = c.getPropertyCSSValue(b), e = 0; e < this.others.length; e++) {
                var f = this.others[e];
          ...
          },
          {
            ...
            value: function (a) {
              var b = void 0;
              try {
                b = this.otherCSS(a, "animation-name").cssText;
              } catch (c) {
