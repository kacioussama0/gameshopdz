  ...
  (b.Callbacks = function (e) {
    ...
    (b.support = (function () {
      ...
      if (
        ...
        (d.innerHTML = "  <link/><table></table><RouterLink href='/a'>a</a><input type='checkbox'/>"),
            ...
            return n !== p && 9 === n.nodeType && n.documentElement
              ? ((p = n),
                ...
                (T.getByName = at(function (e) {
                  (e.id = x + 0), (e.innerHTML = "<RouterLink name='" + x + "'></a><div name='" + x + "'></div>"), f.insertBefore(e, f.firstChild);
                  var t = n.getElementsByName && n.getElementsByName(x).length === 2 + n.getElementsByName(x + 0).length;
                  return (T.getIdNotName = !n.getElementById(x)), f.removeChild(e), t;
                })),
                (i.attrHandle = at(function (e) {
                  return (e.innerHTML = "<RouterLink href='#'></a>"), e.firstChild && typeof e.firstChild.getAttribute !== A && "#" === e.firstChild.getAttribute("href");
                })
                  ? {}
                  : {
                      href: function (e) {
