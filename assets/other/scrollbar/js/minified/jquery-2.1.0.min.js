...
!(function (a, b) {
              ...
              (c = g[b]),
                ...
                g !== d &&
                  (j && d && (o.isPlainObject(d) || (e = o.isArray(d)))
                    ? (e ? ((e = !1), (f = c && o.isArray(c) ? c : [])) : (f = c && o.isPlainObject(c) ? c : {}), (g[b] = o.extend(j, f, d)))
                    : void 0 !== d && (g[b] = d));
        return g;
      }),
    o.extend({
  ...
  var t = (function (a) {
          ...
          preFilter: {
            ...
            CHILD: function (a) {
              return (
                (a[1] = a[1].toLowerCase()),
                "nth" === a[1].slice(0, 3)
                  ? (a[3] || db.error(a[0]), (a[4] = +(a[4] ? a[5] + (a[6] || 1) : 2 * ("even" === a[3] || "odd" === a[3]))), (a[5] = +(a[7] + a[8] || "odd" === a[3])))
                  : a[3] && db.error(a[0]),
                a
              );
            },
            PSEUDO: function (a) {
              ...
              return V.CHILD.test(a[0])
                ? null
                : (a[3] && void 0 !== a[4] ? (a[2] = a[4]) : c && T.test(c) && (b = ob(c, !0)) && (b = c.indexOf(")", c.length - b) - c.length) && ((a[0] = a[0].slice(0, b)), (a[2] = c.slice(0, b))),
                  a.slice(0, 3));
            },
          },
          filter: {
    ...
    return (
      ...
      gb(function (a) {
        return (a.innerHTML = "<RouterLink href='#'></a>"), "#" === a.firstChild.getAttribute("href");
      }) ||
      ...
      return this instanceof o.Event
        ? (a && a.type
            ? ((this.originalEvent = a),
              (this.type = a.type),
              (this.isDefaultPrevented = a.defaultPrevented || (void 0 === a.defaultPrevented && a.getPreventDefault && a.getPreventDefault()) ? Z : $))
            : (this.type = a),
          b && o.extend(this, b),
  ...
  function tb(a) {
    ...
    return (
      c ||
        ((c = sb(a, b)),
        ("none" !== c && c) ||
          ((qb = (qb || o("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement)), (b = qb[0].contentDocument), b.write(), b.close(), (c = sb(a, b)), qb.detach()),
        (rb[a] = c)),
      c
    );
  }
