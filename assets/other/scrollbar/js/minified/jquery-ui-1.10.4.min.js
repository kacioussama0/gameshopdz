...
(function (e, t) {
  ...
  (e.ui = e.ui || {}),
    ...
    e("<RouterLink>").outerWidth(1).jquery ||
    ...
    e("<RouterLink>").data("a-b", "a").removeData("a-b").data("a-b") &&
...
(function (e) {
  e.widget("ui.autocomplete", {
    ...
    _renderItem: function (t, i) {
      return e("<li>").append(e("<RouterLink>").text(i.label)).appendTo(t);
    },
    _move: function (e, t) {
    ...
    _enableDatepicker: function (t) {
      ...
      s.hasClass(this.markerClassName) &&
        ...
        "input" === i
          ...
          : ("div" === i || "span" === i) &&
            ((a = s.children("." + this._inlineClass)), a.children().removeClass("ui-state-disabled"), a.find("select.ui-datepicker-month, select.ui-datepicker-year").prop("disabled", !1)),
    ...
    _disableDatepicker: function (t) {
      ...
      s.hasClass(this.markerClassName) &&
        ...
        "input" === i
          ...
          : ("div" === i || "span" === i) &&
            ((a = s.children("." + this._inlineClass)), a.children().addClass("ui-state-disabled"), a.find("select.ui-datepicker-month, select.ui-datepicker-year").prop("disabled", !0)),
        (this._disabledInputs = e.map(this._disabledInputs, function (e) {
          return e === t ? null : e;
        })),
      ...
      !o ||
        ...
        (this._datepickerShowing &&
          ...
          e.effects && (e.effects.effect[i] || e.effects[i])
            ...
            : o.dpDiv["slideDown" === i ? "slideUp" : "fadeIn" === i ? "fadeOut" : "hide"](i ? a : null, s),
          i || s(),
          (this._datepickerShowing = !1),
      ...
      for (
        e.drawMonth = Z,
          ...
          a = this._canAdjustMonth(e, -1, et, Z)
            ? "<RouterLink class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" +
              i +
            ...
            : B
            ? ""
            : "<RouterLink class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "e" : "w") + "'>" + i + "</span></a>",
          ...
          n = this._canAdjustMonth(e, 1, et, Z)
            ? "<RouterLink class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" +
              s +
              "'><span class='ui-icon ui-icon-circle-triangle-" +
              (L ? "w" : "e") +
              "'>" +
            ...
            : B
            ? ""
            : "<RouterLink class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "w" : "e") + "'>" + s + "</span></a>",
          ...
          c = U
            ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" +
              (L ? u : "") +
              (this._isInRange(e, o)
                ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + r + "</button>"
                : "") +
              (L ? "" : u) +
              "</div>"
            : "",
              ...
              (j = f ? f.apply(e.input ? e.input[0] : null, [F]) : [!0, ""]),
                ...
                (O +=
                  ...
                  (K && !_
                    ...
                    : "<RouterLink class='ui-state-default" +
          ...
          keydown: function (t) {
            ...
            if (t.keyCode === e.ui.keyCode.TAB) {
              ...
              (t.target !== s[0] && t.target !== this.uiDialog[0]) || t.shiftKey
                ? (t.target !== a[0] && t.target !== this.uiDialog[0]) || !t.shiftKey || (s.focus(1), t.preventDefault())
    ...
    _setOption: function (e, t) {
      ...
      "dialogClass" === e && s.removeClass(this.options.dialogClass).addClass(t),
        "disabled" !== e &&
          ...
          "resizable" === e &&
            ((a = s.is(":data(ui-resizable)")), a && !t && s.resizable("destroy"), a && "string" == typeof t && s.resizable("option", "handles", t), a || t === !1 || this._makeResizable()),
        ...
        for (u = p.snapElements.length - 1; u >= 0; u--)
          (r = p.snapElements[u].left),
            ...
            r - f > _ || m > l + f || h - f > b || v > c + f || !t.contains(p.snapElements[u].item.ownerDocument, p.snapElements[u].item)
              ? (p.snapElements[u].snapping && p.options.snap.release && p.options.snap.release.call(p.element, e, t.extend(p._uiHash(), { snapItem: p.snapElements[u].item })),
...
(function (t) {
  (t.effects.effect.puff = function (e, i) {
    ...
    t.extend(e, {
      ...
      complete: i,
      percent: a ? o : 100,
      from: a ? l : { height: l.height * r, width: l.width * r, outerHeight: l.outerHeight * r, outerWidth: l.outerWidth * r },
    }),
      s.effect(e);
  }),
    ...
    (t.effects.effect.size = function (e, i) {
      ...
      "show" === p && o.show(),
        ...
        ("content" === g || "both" === g) &&
          a.from.y !== a.to.y &&
          ((_ = _.concat(c).concat(h)), (o.from = t.effects.setTransition(o, c, a.from.y, o.from)), (o.to = t.effects.setTransition(o, c, a.to.y, o.to))),
        t.effects.save(o, _),
        o.show(),
        t.effects.createWrapper(o),
...
(function (t) {
  t.effects.effect.shake = function (e, i) {
    var s,
      ...
      _ = v.length;
    for (
      t.effects.save(n, a), n.show(), t.effects.createWrapper(n), f[d] = (p ? "-=" : "+=") + l, g[d] = (p ? "+=" : "-=") + 2 * l, m[d] = (p ? "-=" : "+=") + 2 * l, n.animate(f, u, e.easing), s = 1;
      h > s;
      s++
    )
      ...
      resize: function (e) {
        ...
        d[0] !== document && /static/.test(d.css("position")) && (u = h),
          l.left < (o._helper ? h.left : 0) &&
            ((o.size.width = o.size.width + (o._helper ? o.position.left - h.left : o.position.left - u.left)),
            c && (o.size.height = o.size.width / o.aspectRatio),
            (o.position.left = r.helper ? h.left : 0)),
          l.top < (o._helper ? h.top : 0) &&
            ((o.size.height = o.size.height + (o._helper ? o.position.top - h.top : o.position.top)), c && (o.size.width = o.size.height * o.aspectRatio), (o.position.top = o._helper ? h.top : 0)),
        ...
        this.options.disabled ||
          ...
          this.selectees.filter(".ui-selected").each(function () {
            ...
            (s.startselected = !0),
              e.metaKey ||
                e.ctrlKey ||
                (s.$element.removeClass("ui-selected"), (s.selected = !1), s.$element.addClass("ui-unselecting"), (s.unselecting = !0), i._trigger("unselecting", e, { unselecting: s.element }));
          }),
          t(e.target)
            .parents()
            .addBack()
  ...
  t.widget("ui.slider", t.ui.mouse, {
    ...
    _createHandles: function () {
      var e,
        ...
        a = "<RouterLink class='ui-slider-handle ui-state-default ui-corner-all' href='#'></a>",
        o = [];
    ...
    _slide: function (t, e, i) {
      ...
      this.options.values && this.options.values.length
        ? ((s = this.values(e ? 0 : 1)),
          ...
          i !== this.values(e) &&
            ((n = this.values()), (n[e] = i), (a = this._trigger("slide", t, { handle: this.handles[e], value: i, values: n })), (s = this.values(e ? 0 : 1)), a !== !1 && this.values(e, i)))
        ...
        this.position = this._generatePosition(e),
          ...
          this.options.scroll &&
            (this.scrollParent[0] !== document && "HTML" !== this.scrollParent[0].tagName
              ? (this.overflowOffset.top + this.scrollParent[0].offsetHeight - e.pageY < RouterLink.scrollSensitivity
                  ? (this.scrollParent[0].scrollTop = r = this.scrollParent[0].scrollTop + a.scrollSpeed)
                  : e.pageY - this.overflowOffset.top < RouterLink.scrollSensitivity && (this.scrollParent[0].scrollTop = r = this.scrollParent[0].scrollTop - a.scrollSpeed),
                this.overflowOffset.left + this.scrollParent[0].offsetWidth - e.pageX < RouterLink.scrollSensitivity
                  ? (this.scrollParent[0].scrollLeft = r = this.scrollParent[0].scrollLeft + a.scrollSpeed)
                  : e.pageX - this.overflowOffset.left < RouterLink.scrollSensitivity && (this.scrollParent[0].scrollLeft = r = this.scrollParent[0].scrollLeft - a.scrollSpeed))
              : (e.pageY - t(document).scrollTop() < RouterLink.scrollSensitivity
                  ? (r = t(document).scrollTop(t(document).scrollTop() - a.scrollSpeed))
                  : t(window).height() - (e.pageY - t(document).scrollTop()) < RouterLink.scrollSensitivity && (r = t(document).scrollTop(t(document).scrollTop() + a.scrollSpeed)),
                e.pageX - t(document).scrollLeft() < RouterLink.scrollSensitivity
                  ? (r = t(document).scrollLeft(t(document).scrollLeft() - a.scrollSpeed))
                  : t(window).width() - (e.pageX - t(document).scrollLeft()) < RouterLink.scrollSensitivity && (r = t(document).scrollLeft(t(document).scrollLeft() + a.scrollSpeed))),
    ...
    _contactContainers: function (s) {
      ...
      if (f)
        if (1 === this.containers.length) this.containers[g].containerCache.over || (this.containers[g]._trigger("over", s, this._uiHash(this)), (this.containers[g].containerCache.over = 1));
          ...
          for (
            a = 1e4, r = null, p = f.floating || i(this.currentItem), h = p ? "left" : "top", l = p ? "width" : "height", c = this.positionAbs[h] + this.offset.click[h], o = this.items.length - 1;
            o >= 0;
            o--
          )
...
(function (t) {
  ...
  t.widget("ui.spinner", {
    ...
    _buttonHtml: function () {
      return (
        "<RouterLink class='ui-spinner-button ui-spinner-up ui-corner-tr'><span class='ui-icon " +
        this.options.icons.up +
        "'>&#9650;</span>" +
        "</a>" +
        "<RouterLink class='ui-spinner-button ui-spinner-down ui-corner-br'>" +
        "<span class='ui-icon " +
    ...
    _setOption: function (t, e) {
      ...
      ("max" === t || "min" === t || "step" === t) && "string" == typeof e && (e = this._parse(e)),
        "icons" === t &&
          (this.buttons.first().find(".ui-icon").removeClass(this.options.icons.up).addClass(e.up), this.buttons.last().find(".ui-icon").removeClass(this.options.icons.down).addClass(e.down)),
        this._super(t, e),
  ...
  t.widget("ui.tooltip", {
    ...
    options: {
      content: function () {
        ...
        return t("<RouterLink>").text(e).html();
      },
      hide: !0,
