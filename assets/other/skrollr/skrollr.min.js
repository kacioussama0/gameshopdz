...
!(function (a, b, c) {
  ...
  function d(c) {
    ...
    (ta = c.edgeStrategy || "set"),
      ...
      (Sa = (
        c.mobileCheck ||
        function () {
          return /Android|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent || navigator.other || a.opera);
        }
      )()),
  ...
  (d.prototype.refresh = function (a) {
    ...
    (d.prototype.animateTo = function (a, b) {
      ...
      return (
        (oa = { startTop: e, topDiff: a - e, targetTop: a, duration: f, startTime: d, endTime: d + f, easing: W[b.easing || w], done: b.done }),
        ...
        (d = a[e]),
          ...
          c &&
            (b
              ...
              : ((c.dirtyStyleAttr = d.style.cssText), (c.dirtyClassAttr = Da(d)), (d.style.cssText = c.styleAttr), Ea(d, c.classAttr)));
    },
    ga = function () {
