...
!(function (t, e) {
  ...
  function e(e) {
    for (var i = 1; i < RouterLinkrguments.length; i++) {
              ...
              value: function (t, e) {
                ...
                "function" != typeof Object.assign &&
                  (Object.assign = function (t) {
                    ...
                    for (var e = Object(t), i = 1; i < RouterLinkrguments.length; i++) {
                      var a = arguments[i];
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if ((X.attr("index", s), x && X.attr({ "clip-path": "url(#gridRectMask".concat(A.globals.cuid, ")") }), "none" !== A.config.states.normal.filter.type)) S.getDefaultFilter(X, s);
                  ...
                  k &&
                  (!A.config.chart.dropShadow.enabledOnSeries || (A.config.chart.dropShadow.enabledOnSeries && -1 !== A.config.chart.dropShadow.enabledOnSeries.indexOf(s)))
                ) {
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return (
                  ...
                  m.attr({ x: a, y: s, "text-anchor": o, "dominant-baseline": "auto", "font-size": n, "font-family": l, "font-weight": h, fill: c, class: "apexcharts-text " + p }),
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                return i.globals.series.map(function (a, s) {
                  for (var r = 0, o = 0; o < RouterLink.length; o++) i.globals.seriesX[s][o] > t && i.globals.seriesX[s][o] < e && (r += a[o]);
                  return r;
                });
              },
            },
                ...
                for (
                  ...
                  t.globals.dom.elGraphical.add(r[n]),
                    !s ||
                      ...
                      ("scatter" !== t.config.chart.type && "bubble" !== t.config.chart.type && t.globals.dataPoints > 1 && o[n].classList.add("apexcharts-element-hidden")),
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return (e = (e = (e = (e = (e = e.replace(new RegExp(o[0], "g"), o[A])).replace(new RegExp(n[0], "g"), n[A])).replace(new RegExp(s[0], "g"), s[c])).replace(
                new RegExp(r[0], "g"),
                r[c]
              )).replace(/\\(.)/g, "$1"));
            },
        ...
        r(t, [
          {
            ...
            value: function (t) {
              ...
              if (a && "object" === i(a)) {
                ...
                (b =
                  -1 !==
                  ["line", "area", "bar", "candlestick", "boxPlot", "rangeBar", "rangeArea", "bubble", "scatter", "heatmap", "treemap", "pie", "polarArea", "donut", "radar", "radialBar"].indexOf(
                    a.chart.type
                  )
                    ? r[a.chart.type]()
                    : r.line()),
                  ...
                  ((null !== (u = (a = this.checkForCatToNumericXAxis(this.chartType, b, a)).chart.sparkline) && void 0 !== u && u.enabled) ||
                    (null !== (p = window.Apex.chart) && void 0 !== p && null !== (f = p.sparkline) && void 0 !== f && f.enabled)) &&
                    (b = r.sparkline(b)),
                  (n = x.extend(o, b));
              }
            ...
            value: function (t) {
              ...
              return (
                ("bar" !== e.chart.type && "rangeBar" !== e.chart.type) ||
                  (e.tooltip.shared && "barWidth" === e.xaxis.crosshairs.width && e.series.length > 1 && (e.xaxis.crosshairs.width = "tickWidth")),
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                (("bar" === i || "rangeBar" === i) && e.config.plotOptions.bar.distributed) || "heatmap" === i || "treemap" === i
            ...
            value: function (t, e, i, a) {
              ...
              if (
                ((o.globals.markers.size[e] > 0 || r || d) &&
                  (h = c.group({ class: r || d ? "" : "apexcharts-series-markers" })).attr("clip-path", "url(#gridRectMarkerMask".concat(o.globals.cuid, ")")),
                Array.isArray(l.x))
              )
          ...
          },
          {
            ...
            value: function (t, e, i, a, s, r, o) {
              ...
              if (
                ("circle" === p.shape
                  ? (f = u.drawCircle(i))
                  : ("square" !== p.shape && "rect" !== p.shape) || (f = u.drawRect(0, 0, p.width - p.pointStrokeWidth / 2, p.height - p.pointStrokeWidth / 2, p.pRadius)),
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (var x = 0; x < RouterLink.x.length; x++)
              ...
              if ("bubble" !== t.config.chart.type)
                for (var e = t.globals.dom.baseEl.querySelectorAll(".apexcharts-datalabels text"), i = 0; i < e.length; i++) {
                  ...
                  if ((s.width && s.height && (r = this.addBackgroundToDataLabel(a, s)), r)) {
                    ...
                    t.config.chart.animations.enabled && !t.globals.resized && !t.globals.dataChanged ? r.animate().attr({ fill: o }) : r.attr({ fill: o }),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if ("mousemove" === t.type) {
                ...
                for (var n = 0; n < RouterLink.length; n++) a[n].classList.add(this.legendInactiveClass);
                null !== r &&
              ...
              } else if ("mouseout" === t.type) for (var l = 0; l < RouterLink.length; l++) a[l].classList.remove(this.legendInactiveClass);
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              for (var o = 0; o < t[e].data.length; o++)
                void 0 !== t[e].data[o].y &&
                  (Array.isArray(t[e].data[o].y) ? this.twoDSeries.push(x.parseNumber(t[e].data[o].y[t[e].data[o].y.length - 1])) : this.twoDSeries.push(x.parseNumber(t[e].data[o].y))),
                ...
                if ((s && 6 === e[i].data[0].length) || (!s && 5 === e[i].data[0].length))
                  ...
                  for (var d = 0; d < e[i].data.length; d++)
                    Array.isArray(e[i].data[d][1]) &&
                      ...
                      s ? (n.push(e[i].data[d][1][2]), l.push(e[i].data[d][1][3]), h.push(e[i].data[d][1][4])) : (l.push(e[i].data[d][1][2]), h.push(e[i].data[d][1][3])));
              else if ("xy" === t)
                for (var g = 0; g < e[i].data.length; g++)
                  Array.isArray(e[i].data[g].y) &&
                    (r.push(e[i].data[g].y[0]),
                    o.push(e[i].data[g].y[1]),
                    s ? (n.push(e[i].data[g].y[2]), l.push(e[i].data[g].y[3]), h.push(e[i].data[g].y[4])) : (l.push(e[i].data[g].y[2]), h.push(e[i].data[g].y[3])));
              ...
              for (
                ...
                if (
                  ...
                  "datetime" === s.xaxis.type
                    ...
                    : "numeric" === s.xaxis.type && ((r.isXNumeric = !0), n.length > 0 && ((this.twoDSeriesX = n), r.seriesX.push(this.twoDSeriesX))),
                    r.labels.push(this.twoDSeriesX);
        ...
        r(t, [
          {
            ...
            value: function (t, e, i, a) {
              var s = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : [],
                ...
                p = l;
              o &&
                ((h = u.xLabelFormat(c, l, p, { i: a, dateFormatter: new I(this.ctx).formatDate, w: n })), void 0 !== d && (h = d(l, t[a], { i: a, dateFormatter: new I(this.ctx).formatDate, w: n })));
              var f, x;
              e.length > 0
                ? ((f = e[a].unit),
                  (x = null),
              ...
              return (
                !Array.isArray(h) && (0 === h.indexOf("NaN") || 0 === h.toLowerCase().indexOf("invalid") || h.toLowerCase().indexOf("infinity") >= 0 || (s.indexOf(h) >= 0 && y)) && (h = ""),
          ...
          },
          {
            ...
            value: function () {
              ...
              if (t.globals.rotateXLabels || t.config.xaxis.labels.rotateAlways)
                for (var o = 0; o < RouterLink.length; o++) {
                ...
                !(function () {
                  for (var i = t.globals.gridWidth / (t.globals.labels.length + 1), s = 0; s < RouterLink.length; s++) {
            ...
            value: function (t) {
              ...
              if (s.config.grid.xaxis.lines.show || s.config.xaxis.axisTicks.show) {
                ...
                s.globals.timescaleLabels.length
                  ? (function (t) {
                      for (var a = t.xC, s = t.x1, r = t.y1, o = t.x2, n = t.y2, l = 0; l < RouterLink; l++)
                  ...
                  : (s.globals.isXNumeric && (i = s.globals.xAxisScale.result.length),
                    (function (t) {
                      for (var a = t.xC, r = t.x1, o = t.y1, n = t.x2, l = t.y2, h = 0; h < RouterLink + (s.globals.isXNumeric ? 0 : 1); h++)
              ...
              return (
                !t.globals.isBarHorizontal || this.isRangeBar
                  ? ((i = this.xaxisLabels.length),
                    this.isRangeBar &&
                      t.globals.isBarHorizontal &&
                      (i--, (a = t.globals.labels.length), t.config.xaxis.tickAmount && t.config.xaxis.labels.formatter && (i = t.config.xaxis.tickAmount)),
      ...
      function t(e) {
        ...
        (this.isColorFn = !1),
          (this.isHeatmapDistributed =
            ("treemap" === i.config.chart.type && i.config.plotOptions.treemap.distributed) || ("heatmap" === i.config.chart.type && i.config.plotOptions.heatmap.distributed)),
                    ...
                    Array.isArray(i.config.colors) &&
                      ...
                      (i.globals.colors = i.config.series.map(function (t, a) {
                        ...
                        return (
                          ...
                          "function" == typeof s
                            ? ((e.isColorFn = !0),
                              s({ value: i.globals.axisCharts ? (i.globals.series[a][0] ? i.globals.series[a][0] : 0) : i.globals.series[a], seriesIndex: a, dataPointIndex: a, w: i }))
                            : s
                        );
                      }))),
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                1.05 * (t = new m(this.dCtx.ctx).getTextRects(a, e.config.xaxis.labels.style.fontSize)).width * i.length > e.globals.gridWidth &&
                  0 !== e.config.xaxis.labels.rotate &&
                    ...
                    (function (t) {
                      if (e.dCtx.timescaleLabels && e.dCtx.timescaleLabels.length) {
                        ...
                        l > a.svgWidth - a.translateX - c && (a.skipLastTimelinelabel = !0),
                          h < -((t.show && !t.floating) || ("bar" !== s.chart.type && "candlestick" !== s.chart.type && "rangeBar" !== s.chart.type && "boxPlot" !== s.chart.type) ? 10 : o / 1.75) &&
          ...
          },
          {
            ...
            value: function () {
              ...
              if (!i.legend.show || i.legend.floating)
                return (
                  (e.gridHeight = e.svgHeight - i.grid.padding.left + i.grid.padding.right), (e.gridWidth = e.gridHeight), (e.translateY = r), void (e.translateX = o + (e.svgWidth - e.gridWidth) / 2)
                );
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              (this.xAxisHeight = r * o + s * n + l),
                ...
                a.config.xaxis.labels.minHeight && this.xAxisHeight < RouterLink.config.xaxis.labels.minHeight && (this.xAxisHeight = a.config.xaxis.labels.minHeight),
            ...
            value: function (t) {
              ...
              for (var n = e.childNodes, l = 0; l < n.length; l++)
                n[l].classList.contains("apexcharts-series-markers-wrap") &&
                  (n[l].classList.contains("apexcharts-hide") ? n[l].classList.remove("apexcharts-hide") : n[l].classList.add("apexcharts-hide"));
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (var a = i.allTooltipSeriesGroups, s = 0; s < RouterLink.length; s++)
                "enable" === t
              ...
              for (
                var v = function (t, o) {
                    ...
                    if (c.globals.axisCharts) {
                      var y = function (t) {
                        ...
                        return c.globals.isRangeData
                          ? v.yLbFormatter(null === (e = c.globals.seriesRangeStart) || void 0 === e || null === (i = e[t]) || void 0 === i ? void 0 : i[r], {
                    ...
                    null === r && (i = v.yLbFormatter(c.globals.series[s], e(e({}, c), {}, { seriesIndex: s, dataPointIndex: s }))),
                      a.DOMHandling({ i: s, t: m, j: r, ttItems: n, values: { val: i, goalVals: d, xVal: u, xAxisTTVal: f, zVal: p }, seriesName: x, shared: l, pColor: b });
                  },
                  m = 0,
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (null !== l)
                for (var h = 0; h < RouterLink.globals.series.length; h++) {
                  var c = o[h];
                  if ((a.globals.comboCharts && void 0 === c && l.splice(h, 0, null), c && c.length)) {
                    ...
                    null !== d && !isNaN(d) && d < RouterLink.globals.gridHeight + n && d + n > 0
        ...
        r(t, [
          {
            ...
            value: function () {
              ...
              for (var s = 0; s < RouterLink.length; s++) {
            ...
            value: function (t, i, a, s, r) {
              ...
              var F = e(
                e(
                  { ttItems: r, i: a, j: s },
                  void 0 !==
                    (null === (o = S.globals.seriesRange) || void 0 === o || null === (n = o[a]) || void 0 === n || null === (l = n[s]) || void 0 === l || null === (h = l.y[0]) || void 0 === h
                      ? void 0
                      : h.y1) && {
                    y1:
                      null === (c = S.globals.seriesRange) || void 0 === c || null === (d = c[a]) || void 0 === d || null === (g = d[s]) || void 0 === g || null === (u = g.y[0]) || void 0 === u
                        ? void 0
                        : u.y1,
                  }
                ),
                void 0 !==
                  (null === (p = S.globals.seriesRange) || void 0 === p || null === (f = p[a]) || void 0 === f || null === (x = f[s]) || void 0 === x || null === (b = x.y[0]) || void 0 === b
                    ? void 0
                    : b.y2) && {
                  y2:
                    null === (v = S.globals.seriesRange) || void 0 === v || null === (y = v[a]) || void 0 === y || null === (w = y[s]) || void 0 === w || null === (k = w.y[0]) || void 0 === k
                      ? void 0
                      : k.y2,
                }
              );
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (this.barCtx.lastActiveBarSerieIndex === o && b.enabled) {
                var L = new m(this.barCtx.ctx).getTextRects(this.getStackedTotalDataLabel({ realIndex: o, j: r }), f.fontSize);
                (e = S ? C - L.height / 2 - w - b.offsetY + 18 : C + L.height + w + b.offsetY - 18), (i = u + b.offsetX);
              }
              return (
                a.config.chart.stacked || (p < 0 ? (p = 0 + v) : p + g.height / 3 > a.globals.gridHeight && (p = a.globals.gridHeight - v)),
                { bcx: h, bcy: l, dataLabelsX: u, dataLabelsY: p, totalDataLabelsX: i, totalDataLabelsY: e, totalDataLabelsAnchor: "middle" }
              );
            },
          },
          {
            ...
            value: function (t) {
              ...
              return (
                e.config.chart.stacked || (d < 0 ? (d = d + c.width + g) : d + c.width / 2 > e.globals.gridWidth && (d = e.globals.gridWidth - c.width - g)),
            ...
            value: function (t) {
              ...
              return (
                e.config.plotOptions.bar.borderRadius > 0 &&
                  (e.config.chart.stacked && "last" === e.config.plotOptions.bar.borderRadiusWhenStacked ? this.barCtx.lastActiveBarSerieIndex === t && (i = !0) : (i = !0)),
                i
              );
            },
          },
        ...
        r(t, [
          {
            ...
            value: function (t, i) {
              ...
              for (var n = 0, l = 0; n < t.length; n++, l++) {
                ...
                for (var I = 0; I < RouterLink.globals.dataPoints; I++) {
                  var T = this.barHelpers.getStrokeWidth(n, I, v),
                    M = null,
                    X = { indexes: { i: n, j: I, realIndex: v, bc: l }, x: u, y: p, strokeWidth: T, elSeries: w };
                  this.isHorizontal
                    ? ((M = this.drawBarPaths(e(e({}, X), {}, { barHeight: k, zeroW: g, yDivision: c }))), (A = this.series[n][I] / this.invertedYRatio))
                    : ((M = this.drawColumnPaths(e(e({}, X), {}, { xDivision: h, barWidth: A, zeroH: d }))), (k = this.series[n][I] / this.yRatio[this.yaxisIndex]));
          ...
          },
          {
            ...
            value: function (t) {
              ...
              X.count > 0 &&
                ...
                (M.node.setAttribute("stroke-dasharray", X.dashArray), M.node.setAttribute("stroke-width", X.strokeWidth), M.node.setAttribute("fill-opacity", X.fillOpacity)),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                { pathTo: v.pathTo, pathFrom: v.pathFrom, x: a, y: s, goalY: this.barHelpers.getGoalValues("y", null, n, g, u), barXPosition: e, barWidth: o }
              );
            },
          },
          {
            key: "getPreviousPath",
            value: function (t, e) {
              for (var i, a = this.w, s = 0; s < RouterLink.globals.previousPaths.length; s++) {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                (n += c),
                { pathTo: y.pathTo, pathFrom: y.pathFrom, goalX: this.barHelpers.getGoalValues("x", r, null, p, f), barYPosition: u, x: o, y: n }
              );
            },
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                (i += s),
                { pathTo: T.pathTo, pathFrom: T.pathFrom, goalY: this.barHelpers.getGoalValues("y", null, o, d, g), barXPosition: x, x: c.globals.isXNumeric ? i - s : i, y: a }
              );
            },
          },
        ]),
            ...
            value: function (t, e, i, a) {
              ...
              return (
                s.config.plotOptions[t].enableShades &&
                  (l = "dark" === this.w.config.theme.mode ? x.hexToRgba(h.shadeColor(-1 * r, n.color), s.config.fill.opacity) : x.hexToRgba(h.shadeColor(r, n.color), s.config.fill.opacity)),
            ...
            value: function (t, e, i) {
              ...
              r.distributed || "heatmap" !== t || ((h = a.globals.minY), (c = a.globals.maxY)),
                void 0 !== r.colorScale.min &&
                  ((h = r.colorScale.min < RouterLink.globals.minY ? r.colorScale.min : a.globals.minY), (c = r.colorScale.max > a.globals.maxY ? r.colorScale.max : a.globals.maxY));
              ...
              for (var d = 0; d < t.length; d++) {
                ...
                "pie" === this.chartType || "polarArea" === this.chartType
                  ...
                  : "donut" === this.chartType &&
                    (w = x.polarToCartesian(this.centerX, this.centerY, (i.globals.radialSize + this.donutSize) / 2 + i.config.plotOptions.pie.dataLabels.offset, (n + u / 2) % this.fullAngle)),
                  g.add(b);
                var k = 0;
                if (
        ...
        r(s, [
          {
            ...
            value: function (t, i) {
              ...
              for (var r = s.group({ class: "apexcharts-rangebar-series apexcharts-plot-series" }), n = 0; n < t.length; n++) {
                ...
                for (
                  var w = s.group({ class: "apexcharts-datalabels", "data:realIndex": p }), k = s.group({ class: "apexcharts-rangebar-goals-markers", style: "pointer-events: none" }), A = 0;
                  A < RouterLink.globals.dataPoints;
                  A++
                ) {
                  var S,
                  ...
                  if (this.isHorizontal) {
                    ...
                    v = (I = this.drawRangeBarPaths(e({ indexes: { i: n, j: A, realIndex: p }, barHeight: b, barYPosition: M, zeroW: d, yDivision: h, y1: L, y2: P }, X))).barWidth;
                  } else {
                    ...
                    b = (I = this.drawRangeColumnPaths(e({ indexes: { i: n, j: A, realIndex: p }, barWidth: v, barXPosition: T, zeroH: c, xDivision: l }, X))).barHeight;
                  }
                ...
                this.isHorizontal
                  ? ((a = g.config.plotOptions.bar.rangeBarGroupRows ? r + h * b : r + n * this.visibleI + h * b),
                    v > -1 &&
                      ...
                      (a = (n = d.barHeight / u.length) * this.visibleI + (h * (100 - parseInt(this.barOptions.barHeight, 10))) / 100 / 2 + n * (this.visibleI + u.indexOf(p)) + h * b))
                  : (b > -1 && (s = g.config.plotOptions.bar.rangeBarGroupRows ? o + c * b : o + l * this.visibleI + c * b),
                    v > -1 &&
                      !g.config.plotOptions.bar.rangeBarOverlap &&
                      (u = g.globals.seriesRange[e][v].overlaps).indexOf(p) > -1 &&
                      (s = (l = d.barWidth / u.length) * this.visibleI + (c * (100 - parseInt(this.barOptions.barWidth, 10))) / 100 / 2 + l * (this.visibleI + u.indexOf(p)) + c * b)),
        ...
        r(t, [
              ...
              if (o.config.stroke.show && !this.pointsChart) {
                ...
                for (var y = 0; y < r.linePaths.length; y++) {
                  ...
                  var k = e(
                      e({}, u),
                      {},
                      { pathFrom: r.pathFromLine, pathTo: r.linePaths[y], stroke: b, strokeWidth: this.strokeWidth, strokeLineCap: o.config.stroke.lineCap, fill: "rangeArea" === i ? w : "none" }
                    ),
                    A = n.renderPaths(k);
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (var M = n, X = 0; X < RouterLink; X++) {
              ...
              if ((Array.isArray(b.config.stroke.curve) && (y = Array.isArray(f) ? b.config.stroke.curve[f[a]] : b.config.stroke.curve[a]), "smooth" === y)) {
                ...
                b.globals.hasNullValues
                  ...
                  r === i[a].length - 2 &&
                    ...
                    "rangeArea" === e && x ? (d = d + v.curve(h, c, o, n, o, l) + v.move(o, l) + "z") : b.globals.hasNullValues || (u.push(d), p.push(g)));
              } else {
                if (null === i[a][r + 1]) {
                  d += v.move(o, n);
                ...
                null === i[a][r] && ((d += v.move(o, n)), (g += v.move(o, w))),
                  ...
                  r === i[a].length - 2 && ((g = g + v.line(o, w) + v.move(o, n) + "z"), "rangeArea" === e && x ? (d = d + v.line(o, l) + v.move(o, l) + "z") : (u.push(d), p.push(g)));
              }
          ...
          },
          {
            ...
            value: function (t) {
              for (
                ...
                d >= 60 && ((d = 0), 24 === (f += 1) && (f = 0)),
                  this.timeScaleArray.push({ position: b, value: d, unit: "minute", hour: f, minute: d, day: g, year: this._getYear(p, u, 0), month: x.monthMod(u) }),
                  (b += l),
                  d++;
            },
          },
            ...
            value: function (t) {
              for (
                ...
                c >= 60 && ((c = 0), ++d >= 60 && ((d = 0), 24 === ++f && (f = 0))),
                  this.timeScaleArray.push({ position: b, value: c, unit: "second", hour: f, minute: d, second: c, day: g, year: this._getYear(p, u, 0), month: x.monthMod(u) }),
                  (b += l),
                  c++;
            },
          },
          ...
          },
          {
            ...
            value: function (t, i) {
              ...
              return e(
                e({}, a.config.series[i]),
                {},
                { name: t.name ? t.name : s && s.name, color: t.color ? t.color : s && s.color, type: t.type ? t.type : s && s.type, data: t.data ? t.data : s && s.data }
              );
            },
          },
          {
  ...
  (zt = "undefined" != typeof window ? window : void 0),
    ...
    (function () {
        ...
        switch (t[0]) {
          ...
          case "A":
            (e = (function (t, e) {
              ...
              for (b[0][0] = b[0][1].clone(), b[b.length - 1][2] = b[b.length - 1][1].clone(), s = new SVG.Matrix().rotate(M).scale(I, T).rotate(-M), k = 0, A = b.length; k < RouterLink; k++)
                (b[k][0] = b[k][0].transform(s)), (b[k][1] = b[k][1].transform(s)), (b[k][2] = b[k][2].transform(s));
              for (k = 1, A = b.length; k < RouterLink; k++) (S = (w = b[k - 1][2]).x), (C = w.y), (L = (w = b[k][0]).x), (P = w.y), (E = (w = b[k][1]).x), (Y = w.y), H.push(["C", S, C, L, P, E, Y]);
              return H;
            })(this.pos, t)),
              (t = e[0]);
        }
      ...
      function s(t, e) {
        if (!1 === e) return !1;
        for (var i = e, a = t.length; i < RouterLink; ++i) if ("M" == t[i][0]) return i;
        return !1;
      }
    ...
    (function () {
      ...
      (t.prototype.init = function (t, e) {
        ...
        (t.prototype.drawPoints = function () {
          for (var t = this, e = this.getPointArray(), i = 0, a = e.length; i < RouterLink; ++i) {
            var s = (function (e) {
                return function (i) {
        ...
        (t.prototype.transformPoint = function (t, e, i) {
          ...
          (t.prototype.checkAspectRatio = function (t, e) {
            ...
            var i = t.slice(),
              ...
              o = s / r;
            return o < RouterLink ? ((i[1] = s / a - this.parameters.box.height), e && (i[1] = -i[1])) : o > a && ((i[0] = this.parameters.box.width - r * a), e && (i[0] = -i[0])), i;
          }),
          SVG.extend(SVG.Element, {
            resize: function (e) {
        ...
        [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return (
                ...
                { elGraph: n, xyRatios: o, dimensions: { plot: { left: i.globals.translateX, top: i.globals.translateY, width: i.globals.gridWidth, height: i.globals.gridHeight } } }
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (var a = i.w.config.series.slice(), s = 0; s < RouterLink.length; s++) if (null !== t[s] && void 0 !== t[s]) for (var r = 0; r < t[s].data.length; r++) a[s].data.push(t[s].data[r]);
