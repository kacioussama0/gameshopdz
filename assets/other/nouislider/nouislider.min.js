  ...
  function j(t, f, o) {
          ...
          (r = i[(e = t)][0]),
            ...
            (n = o ? o(r, n) : n) !== ot.PipsType.None &&
              ...
              n > ot.PipsType.NoValue &&
                (((t = P(a, !1)).className = p(n, f.cssClasses.value)), t.setAttribute("data-value", String(r)), (t.style[f.style] = e + "%"), (t.innerHTML = String(s.to(r)))));
        }),
        a
      );
    }
    ...
    function B(t, e) {
      ...
      e.handleNumbers.some(k) ||
        ...
        t.cursor && ((w.style.cursor = getComputedStyle(t.target).cursor), 1 < RouterLink.length && ft(d, f.cssClasses.drag), w.addEventListener("selectstart", lt, !1)),
        e.handleNumbers.forEach(function (t) {
          I("start", t);
        }));
    }
    ...
    function W(t, e, r, n, i, o) {
      ...
      return (
        1 < RouterLink.length &&
          ...
          i && e < RouterLink.length - 1 && ((s = S.getAbsoluteDistance(t[e + 1], f.margin, !0)), (r = Math.min(r, s)))),
        1 < RouterLink.length &&
          f.limit &&
          (n && 0 < e && ((s = S.getAbsoluteDistance(t[e - 1], f.limit, !1)), (r = Math.min(r, s))),
          i && e < RouterLink.length - 1 && ((s = S.getAbsoluteDistance(t[e + 1], f.limit, !0)), (r = Math.max(r, s)))),
        f.padding &&
          (0 === e && ((s = S.getAbsoluteDistance(0, f.padding[0], !1)), (r = Math.max(r, s))), e === a.length - 1 && ((s = S.getAbsoluteDistance(100, f.padding[1], !0)), (r = Math.min(r, s)))),
    ...
    function Q(t, e, r, n, i) {
      return (
        ...
        ((e = e), (m[(t = t)] = e), (h[t] = S.fromStepping(e)), (e = "translate(" + $(J(e, 0) - E + "%", "0") + ")"), (a[t].style[f.transformRule] = e), Z(t), Z(t + 1), !0)
      );
    }
    function Z(t) {
      var e, r;
