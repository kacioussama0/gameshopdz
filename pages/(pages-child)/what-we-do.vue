...
onMounted(() => {
  const countUp = new CountUp("what_we_do_count1", 40, {
    duration: 50,
  });
  const countUp2 = new CountUp("what_we_do_count2", 21, {
    duration: 50,
  });
  const countUp3 = new CountUp("what_we_do_count3", 98, {
    duration: 50,
  });
  countUp.start();
  countUp2.start();
...
<template>
  ...
  <div class="page-content bg-light">
    <!--banner-->
    <div class="dz-bnr-inr dz-bnr-inr-lg style-2" :style="`background-image: url(${bg})`">
      <div class="container">
        <div class="row">
          <div class="col-lg-7 col-md-12 col-sm-12">
            <div class="dz-bnr-inr-entry">
              ...
              <div class="dz-media wow rounded fadeInUp" data-wow-delay="0.3s">
                <img src="../../assets/images/about/pic7.jpg" alt="" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
              ...
              <div class="about-content">
                <div class="section-head style-1 wow fadeInUp d-block" data-wow-delay="0.4s">
                  ...
                  <p>
                    ...
                    took a galley of type and scrambled it to make a type specimen book. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                ...
                <div class="row justify-content-center m-b30 text-lg-start text-center">
                  <div class="col-lg-4 col-md-4 col-sm-4 col-4 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="exp-head">
                      <div class="counter-num">
                        <h2 class="d-flex align-items-center"><span class="counter" id="what_we_do_count1">0</span>k+</h2>
                      </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-4 col-4 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="exp-head">
                      <div class="counter-num">
                        <h2 class="d-flex align-items-center"><span class="counter" id="what_we_do_count2">0</span>+</h2>
                      </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-4 col-4 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="exp-head">
                      <div class="counter-num">
                        <h2 class="d-flex align-items-center"><span class="counter" id="what_we_do_count3">0</span>%</h2>
                      </div>
          ...
          <div class="col-lg-5 col-md-12 col-sm-12">
            <div class="about-thumb wow fadeInUp" data-wow-delay="0.8s">
              <img src="../../assets/images/lady3.png" alt="" />
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="get-in-touch bg-secondary">
      ...
      <RouterLink to="/contact-us-1" class="btn btn-light wow fadeInUp" data-wow-delay="0.2s">Get In Touch</RouterLink>
    </section>
