...
import bg from "@/assets/images/background/bg-shape.jpg";
...
<template>
  ...
  <div class="page-content bg-light">
    <!--Banner Start-->
    <div class="dz-bnr-inr" :style="`background-image: url(${bg})`">
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
            <div class="dz-bnr-inr-entry text-start">
              ...
              <nav aria-label="breadcrumb" class="breadcrumb-row">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item">Banner With Image</li>
                </ul>
              </nav>
            </div>
          </div>
        ...
        <div class="row about-style2 align-items-center">
          ...
          <div class="col-lg-6 col-md-12 col-sm-12">
            <div class="about-content">
              <div class="section-head style-1 d-lg-block">
                <h3 class="title">
                  About Pixio Our Story and Mission in Ecommerce
                </h3>
                <p>
