...
onMounted(() => {
  const countUp = new CountUp("counter", 50, {
    duration: 50,
  });
  countUp.start();
});
  ...
  <div class="page-content bg-light">
    ...
    <section class="about-banner overflow-visible">
      ...
      <div class="about-info">
        <h3 class="dz-title">
          <NuxtLink to="/about-me">why Pixio ?</NuxtLink>
        </h3>
        <p class="text mb-0">
            ...
            <div class="about-content">
              <div class="section-head style-2 d-block">
                ...
                <p>
                  ...
                  destination that transcends the ordinary. Our passion for
                  style, quality, and individuality drives our mission. Our
                  collection is a carefully curated blend of timeless classics
                  and the latest trends,
                </p>
                <p>
                  In addition to our extensive collection, we're equally devoted
                  to ensuring your shopping experience is seamless and
                  enjoyable. Our website is designed with your convenience in
                  mind, offering secure transactions and a responsive customer
                  support team to assist you every step of the way.
                </p>
              </div>
              <div class="about-bx-detail">
                <div class="about-bx-pic radius">
                  <img
                    src="../../assets/images/testimonial/testimonial4.jpg"
                    alt=""
                  />
                </div>
                <div>
    ...
    <section class="get-in-touch">
      <div class="m-r100 m-md-r0 m-sm-r0">
        <h3 class="dz-title mb-lg-0 mb-3">
          Questions ?
          <span>Our experts will help find the grar that’s right for you</span>
        </h3>
      </div>
      <NuxtLink to="/contact-us-1" class="btn btn-light">Get In Touch</NuxtLink>
    </section>
    <!-- Get In Touch End -->
    ...
    <section class="content-inner">
      <div class="container">
        <div class="row g-3 g-xl-4">
          <div
            class="col-xl-6 col-lg-8 col-md-12 col-sm-12 wow fadeInUp"
            data-wow-delay="0.1s"
          >
            <div class="section-head">
              ...
              <NuxtLink class="btn btn-secondary me-3" to="/registration"
                >Join Our Team</NuxtLink
              >
            </div>
          </div>
          <div
            class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-6 wow fadeInUp"
            data-wow-delay="0.2s"
          >
            <div class="dz-team style-1 m-md-b0 m-sm-b0 m-b30">
              <div class="dz-media">
                ...
                <ul class="team-social-icon">
                  ...
                  <li>
                    <NuxtLink
                      to="https://twitter.com/dexignzone"
                      target="_blank"
                  ...
                  <li>
                    <NuxtLink
                      to="https://www.linkedin.com/in/dexignzone/"
                      target="_blank"
              ...
              <div class="dz-content">
                <h5 class="title">
                  <NuxtLink to="/our-team">John Doe</NuxtLink>
                </h5>
          ...
          >
            <div class="dz-team style-1 m-md-b0 m-sm-b0 m-b30">
              ...
              <div class="dz-content">
                <h5 class="title">
                  <NuxtLink to="/our-team">Ivan Mathews</NuxtLink>
                </h5>
          ...
          >
            <div class="dz-team style-1 m-md-b0 m-sm-b0 m-b30">
              ...
              <div class="dz-content">
                <h5 class="title">
                  <NuxtLink to="/our-team">Macauley Herring </NuxtLink>
                </h5>
          ...
          >
            <div class="dz-team style-1 m-md-b0 m-sm-b0 m-b30">
              ...
              <div class="dz-content">
                <h5 class="title">
                  <NuxtLink to="/our-team">Alya Levine</NuxtLink>
                </h5>
                <span>CTO </span>
              </div>
            </div>
          ...
          >
            <div class="dz-team style-1 m-md-b0 m-sm-b0 m-b30">
              ...
              <div class="dz-content">
                <h5 class="title">
                  <NuxtLink to="/our-team">Rose Hernandez </NuxtLink>
                </h5>
          ...
          >
            <div class="dz-team style-1 m-md-b0 m-sm-b0 m-b30">
              ...
              <div class="dz-content">
                <h5 class="title">
                  <NuxtLink to="/our-team">Elen Benitez </NuxtLink>
                </h5>
                <span>Designer</span>
              </div>
            </div>
