...
function removeFilter(e: { target: { parentNode: { remove: () => void } } }) {
...
<template>
  ...
  <div class="page-content bg-light">
    <!--Banner Start-->
    <CommonBanner :img="bg" name="Home" title="Shop List" />
    <!--Banner End-->
          ...
          <div class="col-xl-9">
            <div class="filter-wrapper">
              <div class="filter-left-area">
                <ul class="filter-tag">
                  <li>
                    <RouterLink to="" class="tag-btn" @click="removeFilter"
                      >Dresses
                    ...
                    <div class="col-md-12 col-sm-12">
                      <div class="dz-shop-card style-2">
                        ...
                        <div class="dz-content">
                          <div class="dz-header">
                            <div>
                              <h4 class="title mb-0"><RouterLink to="/shop-with-category">Stylish Fedora Hat Collection</RouterLink></h4>
                              <ul class="dz-tags">
                            ...
                            <div class="review-num">
                              ...
                              <span><RouterLink to="?"> 370 Review</RouterLink></span>
                            </div>
                          </div>
                          <div class="dz-body">
                    ...
                    <div class="col-md-12 col-sm-12">
                      <div class="dz-shop-card style-2">
                        ...
                        <div class="dz-content">
                          <div class="dz-header">
                            <div>
                              <h4 class="title mb-0"><RouterLink to="/shop-with-category">Sophisticated Swagger Suit</RouterLink></h4>
                              <ul class="dz-tags">
                                <li><RouterLink to="/shop-with-category">Accessories,</RouterLink></li>
                                <li><RouterLink to="/shop-with-category">Sunglasses</RouterLink></li>
                              </ul>
                            ...
                            <div class="rate">
                              <div class="d-flex align-items-center mb-xl-3 mb-2">
                                ...
                                <div class="meta-content">
                                  ...
                                  <div class="d-flex align-items-center color-filter">
                                    <div class="form-check">
                                      <input class="form-check-input" type="radio" name="radioNoLabel" id="radioNoLabel14" value="#24262B" aria-label="..." checked />
                                      <span style="background-color: rgb(36, 38, 43)"></span>
                                    </div>
                                    <div class="form-check">
                                      <input class="form-check-input" type="radio" name="radioNoLabel" id="radioNoLabel15" value="#8CB2D1" aria-label="..." />
                                      <span style="background-color: rgb(140, 178, 209)"></span>
                                    </div>
                                    <div class="form-check">
                                      <input class="form-check-input" type="radio" name="radioNoLabel" id="radioNoLabel16" value="#0D775E" aria-label="..." />
                                      <span style="background-color: rgb(13, 119, 94)"></span>
                                    </div>
                                  </div>
                                </div>
                    ...
                    <div class="col-md-12 col-sm-12">
                      <div class="dz-shop-card style-2">
                        ...
                        <div class="dz-content">
                          <div class="dz-header">
                            <div>
                              <h4 class="title mb-0"><RouterLink to="/shop-with-category">Retro Sunglasses Collection</RouterLink></h4>
                              <ul class="dz-tags">
                                <li><RouterLink to="/shop-with-category">Accessories,</RouterLink></li>
                                <li><RouterLink to="/shop-with-category">Sunglasses</RouterLink></li>
                              </ul>
                            ...
                            <div class="review-num">
                              ...
                              <span><RouterLink to="?"> 455 Review</RouterLink></span>
                            </div>
                          </div>
                          <div class="dz-body">
                            <div class="dz-rating-box">
                            ...
                            <div class="rate">
                              <div class="d-flex align-items-center mb-xl-3 mb-2">
                                ...
                                <div class="meta-content">
                                  ...
                                  <div class="d-flex align-items-center color-filter">
                                    <div class="form-check">
                                      <input class="form-check-input" type="radio" name="radioNoLabel" id="radioNoLabel17" value="#24262B" aria-label="..." checked />
                                      <span style="background-color: rgb(36, 38, 43)"></span>
                                    </div>
                                    <div class="form-check">
                                      <input class="form-check-input" type="radio" name="radioNoLabel" id="radioNoLabel18" value="#8CB2D1" aria-label="..." />
                                      <span style="background-color: rgb(140, 178, 209)"></span>
                                    </div>
                                    <div class="form-check">
                                      <input class="form-check-input" type="radio" name="radioNoLabel" id="radioNoLabel19" value="#0D775E" aria-label="..." />
                                      <span style="background-color: rgb(13, 119, 94)"></span>
                                    </div>
                                  </div>
                                </div>
