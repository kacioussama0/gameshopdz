              ...
              <div class="swiper-btn-center-lr">
                ...
                >
                  <SwiperSlide class="swiper-slide">
                    <img
                      src="../../assets/images/products/product-detail4/lady.png"
                      alt="image"
                    />
                  </SwiperSlide>
                  <SwiperSlide class="swiper-slide">
                    <img
                      src="../../assets/images/products/product-detail4/lady-2.png"
                      alt="image"
                    />
                  </SwiperSlide>
                  <SwiperSlide class="swiper-slide">
                    <img
                      src="../../assets/images/products/product-detail4/lady-3.png"
                      alt="image"
                    />
                  </SwiperSlide>
                </Swiper>
                ...
                >
                  <SwiperSlide class="swiper-slide">
                    <img
                      src="../../assets/images/products/product-detail4/thumb-img/1.png"
                      alt="image"
                    />
                  </SwiperSlide>
                  <SwiperSlide class="swiper-slide">
                    <img
                      src="../../assets/images/products/product-detail4/thumb-img/2.png"
                      alt="image"
                    />
                  </SwiperSlide>
                  <SwiperSlide class="swiper-slide">
                    <img
                      src="../../assets/images/products/product-detail4/thumb-img/3.png"
                      alt="image"
                    />
                  </SwiperSlide>
                </Swiper>
              ...
              <div class="dz-content">
                <div class="dz-content-footer">
                  <div class="dz-content-start">
                    ...
                    <h4 class="title mb-1">
                      Regular Collar Women Regular Fit Jacket
                    </h4>
                ...
                <div class="row g-lg-4 g-3">
                  <div class="col-xl-4 col-md-4 col-sm-4 col-6">
                    <div class="related-img dz-media">
                      <img
                        src="../../assets/images/feature/product-feature-4/1.png"
                        alt="/"
                      />
                    </div>
                  </div>
                  <div class="col-xl-4 col-md-4 col-sm-4 col-6">
                    <div class="related-img dz-media">
                      <img
                        src="../../assets/images/feature/product-feature-4/2.png"
                        alt="/"
                      />
                    </div>
                  </div>
                  <div class="col-xl-4 col-md-4 col-sm-4">
                    <div class="related-img dz-media">
                      <img
                        src="../../assets/images/feature/product-feature-4/3.png"
                        alt="/"
                      />
                    </div>
                  </div>
