            ...
            <div class="dz-blog blog-single style-1 sidebar">
              ...
              <div class="dz-meta">
                <ul>
                  ...
                  <li class="dz-user">
                    ...
                    By <NuxtLink to="#">KK Sharma</NuxtLink>
                  </li>
                  <li class="dz-comment">
                    <i class="fa-solid fa-message"></i>
                    <NuxtLink to="">24 Comments</NuxtLink>
                  </li>
                </ul>
              </div>

              <Swiper
                class="blog-slideshow swiper m-b30 rounded"
                :loop="true"
                :speed="1500"
                :autoplay="{ delay: 1200 }"
              ...
              >
                <SwiperSlide class="swiper-slide">
                  <img src="../../assets/images/blog/detail/pic4.jpg" alt="/" />
                </SwiperSlide>
                <SwiperSlide class="swiper-slide">
                  <img src="../../assets/images/blog/detail/pic5.jpg" alt="/" />
                </SwiperSlide>
                <SwiperSlide class="swiper-slide">
                  <img src="../../assets/images/blog/detail/pic6.jpg" alt="/" />
                </SwiperSlide>
                <div class="swiper-pagination-two style-2"></div>
              </Swiper>
              <div class="dz-info">
                <div class="dz-post-text">
                  ...
                  <figure
                    class="wp-container-5 wp-block-gallery-3 wp-block-gallery has-nested-images columns-3 is-cropped"
                  >
                    <figure class="wp-block-image size-large">
                      <img
                        src="../../assets/images/blog/blogpost-3/pic1.jpg"
                        alt="/"
                      />
                    </figure>
                    <figure class="wp-block-image size-large">
                      <img
                        src="../../assets/images/blog/blogpost-3/pic2.jpg"
                        alt="/"
                      />
                    </figure>
                    <figure class="wp-block-image size-large">
                      <img
                        src="../../assets/images/blog/blogpost-3/pic3.jpg"
                        alt="/"
                      />
                    </figure>
                    <figure class="wp-block-image size-large">
                      <img
                        src="../../assets/images/blog/blogpost-3/pic4.jpg"
                        alt="/"
                      />
                    </figure>
                    <figure class="wp-block-image size-large">
                ...
                <div class="dz-share-post meta-bottom">
                  <div class="post-tags">
                    <strong>Tags:</strong>
                    <NuxtLink to="#">Dresses</NuxtLink>
                    <NuxtLink to="#">Boots</NuxtLink>
                    <NuxtLink to="#">Jewelry</NuxtLink>
                    <NuxtLink to="#">Jacket</NuxtLink>
                    <NuxtLink to="#">Coat</NuxtLink>
                  </div>
            ...
            <div class="author-box style-1">
              <div class="author-profile-info">
                <div class="author-profile-pic">
                  <img src="../../assets/images/blog/profile.jpg" alt="/" />
                </div>
              ...
              <div class="row">
                <div class="col-lg-6 col-md-6 m-b30">
                  <div class="dz-card style-5">
                    <div class="dz-media">
                      <img
                        src="../../assets/images/blog/blogpost-5/pic1.jpg"
                        alt="/"
                      />
                    </div>
                    <div class="dz-info">
                ...
                <div class="col-lg-6 col-md-6 m-b30">
                  <div class="dz-card style-5">
                    <div class="dz-media">
                      <img
                        src="../../assets/images/blog/blogpost-5/pic2.jpg"
                        alt="/"
                      />
                    </div>
                    <div class="dz-info">
          ...
          <div class="col-xl-4 col-lg-4 col-md-8">
            <div class="side-bar sticky-top mt-lg-0 mt-md-5 mt-3">
              ...
              <div class="widget widget_categories style-1">
                ...
                <ul>
                  <li class="cat-item">
                    <NuxtLink to="/blog-category">Dresses</NuxtLink> (10)
                  </li>
                  <li class="cat-item">
                    <NuxtLink to="/blog-category">Top &amp; Blouses</NuxtLink>
                    (5)
                  </li>
                  <li class="cat-item">
                    <NuxtLink to="/blog-category">Boots</NuxtLink> (17)
                  </li>
                  <li class="cat-item">
                    <NuxtLink to="/blog-category">Jewelry</NuxtLink> (13)
                  </li>
                  <li class="cat-item">
                    <NuxtLink to="/blog-category">Makeup</NuxtLink> (06)
                  </li>
                  <li class="cat-item">
                    <NuxtLink to="/blog-category">Fragrances</NuxtLink> (17)
                  </li>
                  <li class="cat-item">
                    <NuxtLink to="/blog-category"
                      >Shaving &amp; Grooming</NuxtLink
                    >
                    (13)
                  </li>
                  <li class="cat-item">
                    <NuxtLink to="/blog-category">Jacket</NuxtLink> (06)
                  </li>
                  <li class="cat-item">
                    <NuxtLink to="/blog-category">Coat</NuxtLink> (22)
                  </li>
                </ul>
              </div>
                ...
                <div class="widget-post-bx">
                  <div class="widget-post clearfix">
                    ...
                    <div class="dz-info">
                      ...
                      <h6 class="title">
                        <NuxtLink to="/post-standard"
                          >The Anatomy of an Effective Shopping Cart
                          Page</NuxtLink
                        >
                      </h6>
                    </div>
                  ...
                  <div class="widget-post clearfix">
                    ...
                    <div class="dz-info">
                      ...
                      <h6 class="title">
                        <NuxtLink to="/post-standard"
                          >Shopping Cart Security Keeping Your Customers' Data
                          Safe</NuxtLink
                        >
                      </h6>
                    </div>
              ...
              <div class="widget widget_tag_cloud">
                ...
                <div class="tagcloud">
                  <NuxtLink to="/blog-tag">Vintage </NuxtLink>
                  <NuxtLink to="/blog-tag">Wedding</NuxtLink>
                  <NuxtLink to="/blog-tag">Cotton</NuxtLink>
                  <NuxtLink to="/blog-tag">Linen</NuxtLink>
                  <NuxtLink to="/blog-tag">Navy</NuxtLink>
                  <NuxtLink to="/blog-tag">Urban</NuxtLink>
                  <NuxtLink to="/blog-tag">Business Meeting</NuxtLink>
                  <NuxtLink to="/blog-tag">Formal</NuxtLink>
                </div>
              </div>
            </div>
          </div>
