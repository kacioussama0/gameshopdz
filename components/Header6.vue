                ...
                <div class="row">
                  <div class="col-md-4 col-6">
                    <NuxtLink to="/"
                      ...
                      <span class="menu-title">01 Home Page</span></NuxtLink
                    >
                  </div>
                  <div class="col-md-4 col-6">
                    <NuxtLink to="/index-2"
                      ><img src="../assets/images/demo/demo-2.png" alt="/" />
                      <span class="menu-title">02 Home Page</span></NuxtLink
                    >
                  </div>
                  <div class="col-md-4 col-6">
                    <NuxtLink to="/index-3"
                      ><img src="../assets/images/demo/demo-3.png" alt="/" />
                      <span class="menu-title">03 Home Page</span></NuxtLink
                    >
                  </div>
                </div>
              </div>
                      ...
                      <li class="col">
                        <NuxtLink to="/portfolio-tiles"
                          ><img
                            ...
                            alt="/"
                          /><span>Portfolio Tiles</span></NuxtLink
                        >
                      </li>
                      <li class="col">
                        <NuxtLink to="/collage-style-1"
                          ><img
                            ...
                            alt="/"
                          /><span>Collage Style 1</span></NuxtLink
                        >
                      </li>
                      <li class="col">
                        <NuxtLink to="/collage-style-2"
                          ><img
                            ...
                            alt="/"
                          /><span>Collage Style 2</span></NuxtLink
                        >
                      </li>
                      <li class="col">
                        <NuxtLink to="/masonry-grid"
                          ><img
                            ...
                            alt="/"
                          /><span>Masonry Grid</span></NuxtLink
                        >
                      </li>
                      <li class="col">
                        <NuxtLink to="/cobble-style-1"
                          ><img
                            ...
                            alt="/"
                          /><span>Cobble Style 1</span></NuxtLink
                        >
                      </li>
                      <li class="col">
                        <NuxtLink to="/cobble-style-2"
                          ><img
                            ...
                            alt="/"
                          /><span>Cobble Style 2</span></NuxtLink
                        >
                      </li>
                      <li class="col">
                        <NuxtLink to="/portfolio-thumbs-slider"
                          ><img
                            ...
                            alt="/"
                          /><span>Portfolio Thumbs Slider</span></NuxtLink
                        >
                      </li>
                      <li class="col">
                        <NuxtLink to="/portfolio-film-strip"
                          ><img
                            ...
                            alt="/"
                          /><span>Portfolio Film Strip</span></NuxtLink
                        >
                      </li>
                      <li class="col">
                        <NuxtLink to="/carousel-showcase"
                          ><img
                            ...
                            alt="/"
                          /><span>Carousel Showcase</span></NuxtLink
                        >
                      </li>
                      <li class="col">
                        <NuxtLink to="/portfolio-split-slider"
                          ><img
                            ...
                            alt="/"
                          /><span>Portfolio Split Slider</span></NuxtLink
                        >
                      </li>
                    </ul>
                  </div>
