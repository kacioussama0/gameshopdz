      ...
      <div class="container clearfix d-lg-flex d-block">
        ...
        >
          ...
          <div class="browse-category-menu">
            <NuxtLink
              :class="`category-btn ${menu ? 'active' : ''}`"
            ...
            <div class="category-menu-items collapse" id="menu-2">
              <ul class="nav navbar-nav">
                    ...
                    <div class="row">
                      <div class="col-md-3 col-sm-4 col-6">
                        <NuxtLink to="" class="menu-title"
                          >Smart Home Products</NuxtLink
                        >
                        <ul>
                          <li>
                            <NuxtLink to="/shop-standard">Thermostats</NuxtLink>
                          </li>
                          <li>
                            <NuxtLink to="/shop-standard">Lighting</NuxtLink>
                          </li>
                          <li>
                            <NuxtLink to="/shop-standard"
                              >Security Systems<span class="badge bg-primary"
                                >NEW</span
                              ></NuxtLink
                            >
                          </li>
                          <li>
                            <NuxtLink to="/shop-standard">Locks</NuxtLink>
                          </li>
                          <li>
                            <NuxtLink to="/shop-standard"
                              >Home Assistants</NuxtLink
                            >
                          </li>
                          <li>
                            <NuxtLink to="/shop-standard"
                              >Home Entertainment Systems</NuxtLink
                            >
                          </li>
                          <li>
                            <NuxtLink to="/shop-standard"
                              >Blinds And Shades</NuxtLink
                            >
                          </li>
                          <li>
                            <NuxtLink to="/shop-standard"
                              >Water Monitors</NuxtLink
                            >
                          </li>
                        </ul>
                      </div>
                      <div class="col-md-3 col-sm-4 col-6">
                        <NuxtLink to="/shop-standard" class="menu-title"
                          >Smart Home Products</NuxtLink
                        >
                        <ul>
                          <li>
                      ...
                      <div class="col-md-3 col-sm-4 col-6">
                        ...
                        <ul>
                          ...
                          <li>
                            <NuxtLink to="/shop-standard"
                              >Water Monitors<span class="badge bg-red"
                                >Offer</span
                              ></NuxtLink
                            >
                          </li>
                      ...
                      <div class="col-md-3 col-sm-4 col-6">
                        ...
                        <ul>
                          ...
                          <li>
                            <NuxtLink to="/shop-standard"
                              >Lighting<span class="badge bg-secondary"
                                >Exclusive</span
                              ></NuxtLink
                            >
                          </li>
                      ...
                      <div class="col-md-3 col-sm-4 col-6">
                        ...
                        <ul>
                          ...
                          <li>
                            <NuxtLink to="/shop-standard"
                              >Lighting<span class="badge bg-orange"
                                >Feture</span
                              ></NuxtLink
                            >
                          </li>
                      ...
                      <div class="col-md-3 col-sm-4 col-6">
                        ...
                        <ul>
                          ...
                          <li>
                            <NuxtLink to="/shop-standard"
                              >Locks<span class="badge bg-purple"
                                >SALE</span
                              ></NuxtLink
                            >
                          </li>
                ...
                <li class="cate-drop">
                  ...
                  <ul class="sub-menu">
                    ...
                    <li><NuxtLink to="/shop-standard">Lighting</NuxtLink></li>
                    <li>
                      <NuxtLink to="/shop-standard">Security Systems</NuxtLink>
                    </li>
                    <li><NuxtLink to="/shop-standard">Locks</NuxtLink></li>
                    <li>
                      <NuxtLink to="/shop-standard">Home Assistants</NuxtLink>
                    </li>
                    <li>
                      <NuxtLink to="/shop-standard"
                        >Entertainment Systems</NuxtLink
                      >
                    </li>
                    <li>
                      <NuxtLink to="/shop-standard">Blinds And Shades</NuxtLink>
                    </li>
                    <li><NuxtLink to="/shop-standard">Appliances</NuxtLink></li>
                    <li>
                      <NuxtLink to="/shop-standard">Water Monitors</NuxtLink>
                    </li>
                    <li>
                      <NuxtLink to="/shop-standard">Gardening Systems</NuxtLink>
                    </li>
                  </ul>
                </li>
