  ...
  >
    <div class="main-bar clearfix">
      <div class="container-fluid clearfix d-lg-flex d-block">
        ...
        <!-- Main Nav -->
        <div
          :class="`header-nav w3menu navbar-collapse justify-content-end w3menu ${
            isMenu ? 'show' : ''
          }`"
        ...
        >
          ...
          <ul class="nav navbar-nav">
                      ...
                      <li class="month-deal">
                        ...
                        <div class="sale-countdown">
                          <div class="countdown text-center">
                            <div class="date">
                              <span class="time days text-primary">30</span>
                              <span class="work-time">Days</span>
                            </div>
                            <div class="date">
                              <span class="time hours text-primary">04</span>
                              <span class="work-time">Hours</span>
                            </div>
                            <div class="date">
                              <span class="time mins text-primary">28</span>
                              <span class="work-time">Minutess</span>
                            </div>
                            <div class="date">
                              <span class="time secs text-primary">14</span>
            ...
            <li class="sub-menu-down menu-right">
              <NuxtLink to=""
                ><span>Menu</span><i class="fas fa-chevron-down tabindex"></i
              ></NuxtLink>
              <ul class="sub-menu">
                <li><NuxtLink to="">Nav link 1</NuxtLink></li>
                <li class="sub-menu-down">
                  <NuxtLink to="">Nav link 2</NuxtLink>
                  <ul class="sub-menu">
                    <li><NuxtLink to="">Nav link 1</NuxtLink></li>
                    <li class="sub-menu-down">
                      <NuxtLink to="">Nav link 2</NuxtLink>
                      <ul class="sub-menu">
                        <li><NuxtLink to="">Nav link 1</NuxtLink></li>
                        <li><NuxtLink to="">Nav link 2</NuxtLink></li>
                        <li><NuxtLink to="">Nav link 3</NuxtLink></li>
                        <li><NuxtLink to="">Nav link 4</NuxtLink></li>
                        <li><NuxtLink to="">Nav link 5</NuxtLink></li>
                      </ul>
                    </li>
                    <li><NuxtLink to="">Nav link 3</NuxtLink></li>
                    <li><NuxtLink to="">Nav link 4</NuxtLink></li>
